...
<main class="row">
    <div class="col-12">
        <section class="my-4 text-center">
            ...
            <iframe width="1000" height="600" src="https://www.youtube.com/embed/kF6tg5TnxbA?si=CLcQyrcjvTu5wWGo&autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen class="mx-auto" muted></iframe>
        </section>
    </div>
    <section class="my-4">
            ...
            <div class="row">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/card/home?id=<?=$kids['id']?>" class="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="..." alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title"><?=$kids2['title']?></h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="/card/home?id=<?=$kids2['id']?>" class="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
