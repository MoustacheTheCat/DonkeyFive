...
--
-- Hôte : localhost:3306
-- Généré le : lun. 04 déc. 2023 à 08:34
...
CREATE TABLE `centers` (
  ...
  `centerPicture` varchar(100) DEFAULT NULL
...
INSERT INTO `centers` (`centerId`, `centerName`, `centerCity`, `centerAddress`, `centerZip`, `centerCountry`, `centerNumber`, `centerEmail`, `createdAt`, `updatedAt`, `centerInfo`, `centerPicture`) VALUES
(1, 'Donkey Five Paris', 'Paris', '123 Rue de Paris', '75001', 'France', '0123456789', 'contact@paris.fr', '2023-11-27 11:30:18', '2023-11-27 11:30:18', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Iaculis eu non diam phasellus. Vel fringilla est ullamcorper eget nulla facilisi etiam dignissim diam. Donec et odio pellentesque diam. Aliquam id diam maecenas ultricies mi eget. Accumsan tortor posuere ac ut consequat semper viverra nam libero. In iaculis nunc sed augue. Velit aliquet sagittis id consectetur purus ut faucibus. Nulla porttitor massa id neque aliquam.', NULL),
...
CREATE TABLE `fields` (
  ...
  `fieldPicture` varchar(255) DEFAULT NULL,
  `centerId` int(11) DEFAULT NULL,
  `filedDescription` varchar(255) DEFAULT NULL,
  `createdAt` timestamp NULL DEFAULT current_timestamp(),
  `updatedAt` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'mathieu', 'joubert', '1990-10-24', '29 rue du ruisseau', 93100, 'Montreuil', 'France', '$argon2i$v=19$m=65536,t=4,p=1$bXlZMHpWcXQvNFBHM1NmWA$Wz0/HZN5GD4Bgio4NK3vqJZ3M02F1xbxX1OXBmBE8Ho', 'joubert.mathieu753783@gmail.com', 615835301, 'chat_moustache_013-1068x1324-684544402.jpg', 2, '2023-11-29 14:32:03', '2023-11-29 14:32:03'),
(6, 'admin', 'donkeyFive', '1994-08-18', NULL, NULL, NULL, NULL, '$argon2i$v=19$m=65536,t=4,p=1$SHVEYW15L0NUZ0MzUEplOQ$XuBnKcjEG0SWyP9xPXF4Z0MH7GYuD3f9ewcXdvnwy08', 'mattou83075@gmail.com', 644647815, NULL, 1, '2023-12-02 21:20:42', '2023-12-02 21:20:42'),
(9, 'Adel', 'test', '1991-12-04', 'test', 75018, 'Paris', 'France', '$argon2i$v=19$m=65536,t=4,p=1$TUR5ODJiY2FiVWEuakM3MA$CWbp7gNsnJEoDn8Q8FLNyfpzBna3VCyRT8GQKlfZr7Y', 'adeldahache@gmail.com', 601010101, 'default.png', 2, '2023-12-03 19:41:09', '2023-12-03 19:41:09');
...
--
ALTER TABLE `centers`
  MODIFY `centerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT pour la table `fields`
--
ALTER TABLE `fields`
  MODIFY `fieldId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
